...
//     const query = qs.parse(options.url);    // 获取get请求参数
//     return Mock.mock({
//         code: 0,
//         msg: "",
//         data: {
...
//                 id: "@guid",
//                 title: "@ctitle",
//                 description: "@cparagraph(1, 20)",
//                 category: {
//                     "id|1-10": 0,
//                     name: "分类@id"
//                 },
//                 scanNumber: "@integer(300, 5000)",
//                 commentNumber: "@integer(300, 5000)",
...
//         "thumb|1": ["@image(300x250, #525252, #D70EFF, Random Image)", null],
//     }
// })

// Mock.mock('/api/comment', 'post', function (options = {}) {
//   const { nickname, content, blogId } = JSON.parse(options.body);
//   return Mock.mock({
//     code: 0,
//     msg: "",
//     data: {
...
//       blog: {
//         id: blogId || "@integer(1,10)",
//         title: "@ctitle(3,5)",
//       },
//       createDate: "@datetime",
//       // "avatar|1": [
//       //     "https://tse3-mm.cn.bing.net/th/id/OIP-C.4b3LSif-QcW9wtz5NsO4ewHaHa?w=191&h=191&c=7&r=0&o=5&dpr=1.3&pid=1.7",
//       //     "https://tse1-mm.cn.bing.net/th/id/OIP-C.qOslSd4--K6pvcWrq0zA6wHaHa?w=246&h=185&c=7&r=0&o=5&dpr=1.3&pid=1.7",
//       //     "https://tse1-mm.cn.bing.net/th/id/OIP-C.6mMasuc3vVIcIdtT8uDOoAHaE8?w=277&h=185&c=7&r=0&o=5&dpr=1.3&pid=1.7",
//       //     "https://tse2-mm.cn.bing.net/th/id/OIP-C.lN3Z2qoUn1JO_-MP5OMCWgAAAA?w=298&h=177&c=7&r=0&o=5&dpr=1.3&pid=1.7"
//       // ]
